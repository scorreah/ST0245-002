 ...
 *
 * @autor Mauricio Toro, Andrés Páez
 * @version 1
 */
...
public class Taller3 {
     ...
     * El método torresDeHannoi es un auxiliar del proceso 
     * @param n numero de discos
     * @param origen la torre número uno donde se posicionan todos los discos antes
     ...
     *
     * @See < un  href = " http://www.uterra.com/juegos/torre_hanoi.php " > Simulación del Funcionamiento </a>
     * @See < un  href = " https://es.wikipedia.org/wiki/Torres_de_Han%C3%B3i " > Un poco de historia </a>
     */	
    ...
    private static void  permutationAux ( String pref , String  str ) {
        if(str.length()==0){
            ...
            for(int i = 0; i< str.length(); i++){
                permutationAux(pref+str.substring(i,i+1), str.substring(0,i)+ str.substring(i+1, str.length())); 
            }
        }
    }
