...
/**
 * Write a description of class Taller2 here.
 * 
 * @author (your name) 
 ...
 *
 *@autor Mauricio Toro, Camilo Paez, David Gomez, Simon Correa
 *@version 1
 */
...
public class Taller2 {
    ...
    private static boolean SumaGrupo(int start, int[] nums, int target) {
        ...
        else return SumaGrupo(start+1, nums, target - nums[start]) || SumaGrupo(start+1, nums, target);
    }
